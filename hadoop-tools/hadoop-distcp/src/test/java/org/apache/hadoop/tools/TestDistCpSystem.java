...
public class TestDistCpSystem extends TestCase {
  ...
  private void testPreserveUserHelper(FileEntry[] srcEntries,
    ...
    try {
      ...
      String[] args = update ? new String[] { "-pu", "-update", nnUri + testSrc, nnUri + testDst } : new String[] {
          "-pu", nnUri + testSrc, nnUri + testDst
        };
